The following documentation is for `v1.0.12` and is legacy documentation. The utilized syntax, ideas, and more are not applied in `v2.0` or above.

# Magic IndexedDb - v1.0 LEGACY
