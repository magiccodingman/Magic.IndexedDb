...
function buildIndexMetadata(table) {
...
export async function* magicQueryYield(table, nestedOrFilter,
    ...
    let { indexedQueries, compoundIndexQueries, cursorConditions } =
        partitionQueryConditions(nestedOrFilter, queryAdditions, indexCache, requiresCursor);
 ...
 */
function partitionQueryConditions(nestedOrFilter, queryAdditions, indexCache, requiresCursor) {
...
function validateQueryAdditions(queryAdditions, indexCache) {
